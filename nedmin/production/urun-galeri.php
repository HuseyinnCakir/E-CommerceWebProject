                ...
                $urunfotosor->execute(array(
                  ...
                  <div class="col-md-55">
                   <label>
                    ...
                    <?php  $urunfotosec=0; array("$urunfotosec"); ?>
                  ...
                  <ul class="pagination">
                    ...
                    while ($sayfano < $toplam_sayfa) {
                      ...
                      <li class="active">
                        ...
                        <a href="urun-galeri.php?sayfa=<?php echo $sayfano; ?>"><?php echo $sayfano; ?></a>
