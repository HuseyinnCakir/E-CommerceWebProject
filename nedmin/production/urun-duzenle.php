...
$urunsor=$db->prepare("SELECT urun_id,kategori_id,urun_ad,urun_detay,urun_fiyat,urun_video,urun_keyword,urun_seourl,urun_stok,urun_durum,urun_onecikar FROM urun where urun_id=:id");
          ...
          <div class="x_content">
            ...
            <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Ürün Seourl <span class="required">*</span>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" disabled="" id="first-name" name="urun_seourl" value="<?php echo $uruncek['urun_seourl'] ?>" required="required" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
