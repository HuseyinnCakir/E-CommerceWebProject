			...
			<div class="row">
				<div class="col-md-4"><!--footer twitter widget-->
					<div class="title-widget-bg">
						<div class="title-widget">Sosya Medya</div>
					</div>
					<ul class="tweets">
						<li>İnstagram hesabımızı takip edin ve indirimlerden haberdar olun <a href="#">http://t.co/LbLwldb6 </a>
						<span>15 hours ago</span></li>
						<li class="lastone">Trendde olan ürünümüz= <a href="#">http://t.co/LbLwldb6 </a>
						<span>2 hours ago</span></li>
					</ul>
					<div class="clearfix"></div>
					<a href="#" class="btn btn-default btn-follow"><i class="fa fa-twitter fa-2x"></i><div>Twitter'dan takip</div></a>
				</div><!--footer twitter widget-->
				<div class="col-md-4"><!--footer newsletter widget-->
					<div class="title-widget-bg">
						<div class="title-widget">Bültene Üye olun</div>
					</div>
					<div class="newsletter">
						<p>
							Özel indirimlerden haberdar olmanız için e postanızla üye olun, e posta atalım :)
						</p>
						<form role="form">
							<div class="form-group">
								<label>E posta adresiniz</label>
								<input type="email" class="form-control newstler-input" id="exampleInputEmail1" placeholder="Mailinizi Giriniz..">
			...
			<div class="row">
				<div class="col-md-9">
					<ul class="footermenu"><!--footer nav-->
						...
						<li><a href="odeme">Siparişleri Tamamla</a></li>
